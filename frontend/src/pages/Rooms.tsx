        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="bg-muted/50 border-b border-border">
              {["Room No.", "Hostel", "Block", "Floor", "Type", "AC", "Capacity", "Fee/Month", "Status"].map((h) => (
          ...
          <tbody>
            <tr>
              <td colSpan={9} className="text-center py-16 text-xs text-muted-foreground">
                No rooms yet. Connect a database to load data.
              </td>
            </tr>
          </tbody>
        </table>
